function [new_velocity, new_position, new_sequence_pos,new_sequence_vel, flag] = intra_hierarchical_competition(particles,sequence, i, hierarchy,particle_swarm_hierarchy,phi)
